...
var $tab_en_edic = null,
    ...
    newColHtml = '<div class="btn-group pull-right">' +
        ...
        '</button>' +
        '<button id="bElim" type="button" class="btn btn-sm btn-secondary" onclick="rowElim(this);">' +
        '<i class="fas fa-trash-alt"></i>' +
        '</button>' +
        '<button id="bAcep" type="button" class="btn btn-sm btn-primary" style="display:none;" onclick="rowAcep(this);">' +
        '<i class="fas fa-check"></i>' +
        '</button>' +
        '<button id="bCanc" type="button" class="btn btn-sm btn-secondary" style="display:none;" onclick="rowCancel(this);">' +
